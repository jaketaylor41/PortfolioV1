  ...
  <div className={classes.IntroDiv}>
    <div className={classes.IntroTitleDiv}>
      ...
      <div className={classes.Socials}>
        ...
        <a
          href="https://github.com/jaketaylor41"
        ...
        <a
          href="https://www.linkedin.com/in/jacob-taylor41/"
          rel="noopener noreferrer"
          target="_blank"
        >
        ...
        <div className={classes.Spacer}></div>
        <a
          href="https://www.instagram.com/jake.taylor41/"
          rel="noopener noreferrer"
          target="_blank"
        >
      ...
      <div className={classes.ContactBtnDiv}>
        <a
          href="mailto:jacobdeantaylor@gmail.com"
